...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://lukaszmazurkiewicz.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElements(By.xpath("//a[@class=\"board-tile\"]")).stream()
                .filter(aHref -> aHref.findElements(By.xpath(".//div[@title=\"testBoard\"]")).size() > 0)
    ...
    private void deleteTaskFromCrudApp(String taskName) throws InterruptedException {
        ...
        driver.findElements(By.xpath("//form[@class = \"datatable__row\"]")).stream()
                ...
                .collect(Collectors.toList())
                .forEach(p -> {
                    WebElement deleteButton = p.findElement(By.xpath(".//button[4]"));
                    deleteButton.click();
                });
